...
const translations = {
  zh: {
    ...
    'filebox.remote.btn': '从链接转存',
    'filebox.remote.placeholder': '输入 HTTP/HTTPS 下载链接',
    'filebox.remote.transferring': '正在拉取并转存文件...',
    'filebox.remote.err_invalid': '链接格式不正确',
  ...
  en: {
    ...
    'filebox.remote.btn': 'Add from URL',
    'filebox.remote.placeholder': 'Enter HTTP/HTTPS download URL',
    'filebox.remote.transferring': 'Fetching and transferring file...',
    'filebox.remote.err_invalid': 'Invalid URL format',
